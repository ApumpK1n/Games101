...
board_states_right = ti.Vector.field(2, float)
board_states_left = ti.Vector.field(2, float)
...
def confine_position_to_boundary(p):
    bmin = ti.Vector([board_states_left[None][0] + particle_radius_in_world, 0]) 
    bmax = ti.Vector([board_states_right[None][0], boundary[1]
...
def init_particles():
    ...
    board_states_right[None] = ti.Vector([boundary[0] - epsilon, -0.0])
    board_states_left[None] = ti.Vector([0 + epsilon, -0.0])
